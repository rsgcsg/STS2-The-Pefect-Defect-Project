...
from spireagent.hub.uploads import LocalStaging, S3Staging, Staging, UploadService
...
def configured_service(args: Any) -> UploadService:
    ...
    staging: Staging
    if args.staging == "s3":
        from spireagent.storage.s3 import S3Config, client_for
...
def main() -> int:
    ...
    try:
        ...
        if args.command == "register":
            ...
            from spireagent.hub.member_api import refresh_project_statistics
            ...
            from spireagent.hub.member_api import grant_collection_sharing
            ...
            from spireagent.hub.pipeline import prepare_features
            from stpd.cloud_jobs.contracts import FeatureJobSpec
            ...
            from stpd.cloud_jobs.execution import prepare_feature_run
            ...
            from spireagent.hub.verification_worker import supervise_pending_upload

            secret = os.environ.get("STPD_HUB_ADMIN_TOKEN", "")
            from spireagent.hub.console_auth import configured_access
            ...
            if args.modal_target is not None:
                ...
                from stpd.cloud_jobs.modal import ModalProvider, ModalTarget
