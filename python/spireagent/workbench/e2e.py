...
from spireagent.workbench.control import doctor
from stpd.fullrun.data import admit, load_dataset, publish_dataset, publish_source
from stpd.fullrun.features import compile_features, publish_model_view
...
def run_e2e(root: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="stpd-cpu-e2e-") as temporary:
        ...
        from stpd.fullrun.campaign import default_harness_config
        from stpd.fullrun.gold import GoldAnnotation
